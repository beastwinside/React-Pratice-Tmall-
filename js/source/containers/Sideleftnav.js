	...
	scrolltoshow(){
		...
		window.onscroll = function(){
			...
			if( scrollTop>=500){document.getElementById("sideleft").style.display='block';
		       if(scrollTop>=500&&scrollTop<1100){clear();xx[0].style.backgroundColor="#E1145A";}
		else if(scrollTop>=1100&&scrollTop<1700){clear();xx[1].style.backgroundColor="#E1145A";}
		else if(scrollTop>=1700&&scrollTop<2300){clear();xx[2].style.backgroundColor="#E1145A";}
		else if(scrollTop>=2300&&scrollTop<2900){clear();xx[3].style.backgroundColor="#E1145A";}
		else if(scrollTop>=2900&&scrollTop<3500){clear();xx[4].style.backgroundColor="#E1145A";}
		else if(scrollTop>=3500&&scrollTop<4100){clear();xx[5].style.backgroundColor="#E1145A";}
		else if(scrollTop>=4100&&scrollTop<4700){clear();xx[6].style.backgroundColor="#E1145A";}
		else if(scrollTop>=4700&&scrollTop<5300){clear();xx[7].style.backgroundColor="#E1145A";}
		else if(scrollTop>=5300&&scrollTop<5900){clear();xx[8].style.backgroundColor="#E1145A";}
		else if(scrollTop>=5900&&scrollTop<6500){clear();xx[9].style.backgroundColor="#E1145A";}
		else if(scrollTop>=6500&&scrollTop<7100){clear();xx[10].style.backgroundColor="#E1145A";}
		else if(scrollTop>=7100&&scrollTop<7700){clear();xx[11].style.backgroundColor="#E1145A";}}
