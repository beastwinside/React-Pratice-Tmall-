本app由React编写，程序入口为index.html，js文件已经过编译打包，直接打开index.html即可见效果。

因本人时间有限，本demo也是为了应付实习生招聘所用1周时间临时开发，暂时有好多小细节未处理，如数据读取未用json，react配套的redux与react router也因本人还未学到，暂时没有应用到本app，后台的处理随已学习过node.js（不精，仍待深入学习）与php，也是由于时间原因，未作后台程序编写，这些部分会随着后续知识的学习来补上。在本人正式版简历中能见到完整项目，还望见谅！
